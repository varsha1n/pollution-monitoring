...
def NO2_Time_Series(city, date, plot_file_path):
    ...
    # Load the NO2 and CO image collections
    collection = (
    ...
    NO2_mean = collection.mean().clip(buffered_bangalore_geometry)
    H2O_mean = watervapor_collection.mean().clip(buffered_bangalore_geometry)
    ...
    # Calculate XCO
    XCO = NO2_mean.divide(TC_dry_air).rename("XCO")
    ...
    ax.set_title("NO2 Concentration around Bangalore in 2019 (25km radius)")
...
if __name__ == "__main__":
    ...
    NO2_Time_Series(city, date, plot_file_path)
